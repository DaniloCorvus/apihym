...
<body>
    <div>
        ...
        <div style="width:100% !important;max-width: 5cm !important;">
            ...
            <span style="margin: 0;font-family: \'Open Sans Condensed\', sans-serif;font-size: 18px;float: left; font-weight: bold">Egreso Nº:
            </span>

          
            <span style="margin: 0;font-family: \'Open Sans Condensed\', sans-serif;font-size: 18px;float: right; font-weight: bold">{{ preg_replace("/EGR/", '', $egreso->Codigo) }}</span><br>
            ...
            <span style="margin: 0;font-family: \'Open Sans Condensed\', sans-serif;font-size: 12px;float: right;">
                {{\Carbon\Carbon::parse($egreso->Fecha)->format('Y-m-d h:i:s')}}
            </span><br>
